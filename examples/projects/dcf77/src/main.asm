...
.equ SPI_SS_ETHERNET = 1<<PB0
.equ SPI_SS_DCF77 = 1<<PB1
...
; SCRATCHED: scratch0
spi_transmit:
; TODO: Pull the corresponding slave-select PIN low
; TODO: Time to wait until transmission starts ?
...
.wait
  ...
  sbrs scratch0, SPIF
  rjmp wait
; TODO: Pull the corresponding slave-select PIN HIGH
  ret
