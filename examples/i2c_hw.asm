...
.equ BYTES_PER_ROW = DISPLAY_WIDTH_IN_PIXEL/8
...
; INPUT: r20 - Y
; INPUT: r27:r26 - String to print (FLASH)
; SCRATCHED: r0,r1,r2,r3,r16,r17,r18,r19,r20,r27:r26,r29:r28,r31:r30
; ======
write_string:
...
; INPUT: r17 - row (X)
; INPUT: r18 - column (Y)
; SCRATCHED: r0,r1,r2,r3,r16,r17,r18,r29:r28,r31:r30
; =======
write_char:
...
;	ldi r16 , GLYPH_HEIGHT_IN_BITS ; write 8 bytes (TODO: Hard-coded glyph heigh)
	ldi r16 , 8 ; write 8 bytes (TODO: Hard-coded glyph heigh)
.row_loop
	lpm r18,Z+
	st r29:r28,r18
	adiw r29:r28,1
