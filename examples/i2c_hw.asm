...
; INPUT: r17 - X byte offset
; INPUT: r18 - page no. (0...7)
; INPUT: r19 - bit mask
; RESULT: r16 - byte with column data
; SCRATCHED: r1:r0,r16,r20,r31:r30
...
.error
	...
	ret
; ======
; read page column from framebuffer
; INPUT: r17 - X byte offset
; INPUT: r18 - page no. (0...7)
; INPUT: r19 - bit mask
; RESULT: r16 - byte with column data
...
read_column: 
	...
	adc r31,r20 ; +carry
          ...
          ldi r20,8
	mul r20,r18
	ldi r20,BYTES_PER_ROW
	mul r0,r20 ; r1:r0 = y * 8 * BYTES_PER_ROW
	add r30,r0
	adc r31,r1
; Z now points to start of page in frame buffer, gather bits now
	ldi r16,0 ; clear result
	ldi r20,8 ; counter: 8 bits to gather	
.scan_loop
	ld r1,Z
	adiw r31:r30,BYTES_PER_ROW ; advance to next framebuffer row
	lsr r16 ; shift result
	and r1,r19 ; apply mask
	breq skip
	ori r16,128
.skip
	dec r20
...
; Z now points to start of glyph in font ROM
	...
	ldi r16,8
	mul r18,r16 ; r1:r0 = column * 8
          ldi r16,DISPLAY_WIDTH_IN_PIXEL / GLYPH_WIDTH_IN_BITS ; 128 / 8
	mul r0,r16 ;  r1:r0 = column * 8 * BYTES_PER_ROW
	add r0,r2
	adc r1,r3
...
; data organization: rows NONE
charset:
    .db 0x3c,0x66,0x6e,0x6e,0x60,0x62,0x3c,0x00 ; '@' (offset 0)
    .db 0x18,0x3c,0x66,0x7e,0x66,0x66,0x66,0x00 ; 'a' (offset 8)
    .db 0x7c,0x66,0x66,0x7c,0x66,0x66,0x7c,0x00 ; 'b' (offset 16)
    .db 0x3c,0x66,0x60,0x60,0x60,0x66,0x3c,0x00 ; 'c' (offset 24)
    .db 0x78,0x6c,0x66,0x66,0x66,0x6c,0x78,0x00 ; 'd' (offset 32)
    .db 0x7e,0x60,0x60,0x78,0x60,0x60,0x7e,0x00 ; 'e' (offset 40)
    .db 0x7e,0x60,0x60,0x78,0x60,0x60,0x60,0x00 ; 'f' (offset 48)
    .db 0x3c,0x66,0x60,0x6e,0x66,0x66,0x3c,0x00 ; 'g' (offset 56)
    .db 0x66,0x66,0x66,0x7e,0x66,0x66,0x66,0x00 ; 'h' (offset 64)
    .db 0x3c,0x18,0x18,0x18,0x18,0x18,0x3c,0x00 ; 'i' (offset 72)
    .db 0x1e,0x0c,0x0c,0x0c,0x0c,0x6c,0x38,0x00 ; 'j' (offset 80)
    .db 0x66,0x6c,0x78,0x70,0x78,0x6c,0x66,0x00 ; 'k' (offset 88)
    .db 0x60,0x60,0x60,0x60,0x60,0x60,0x7e,0x00 ; 'l' (offset 96)
    .db 0x63,0x77,0x7f,0x6b,0x63,0x63,0x63,0x00 ; 'm' (offset 104)
    .db 0x66,0x76,0x7e,0x7e,0x6e,0x66,0x66,0x00 ; 'n' (offset 112)
    .db 0x3c,0x66,0x66,0x66,0x66,0x66,0x3c,0x00 ; 'o' (offset 120)
    .db 0x7c,0x66,0x66,0x7c,0x60,0x60,0x60,0x00 ; 'p' (offset 128)
    .db 0x3c,0x66,0x66,0x66,0x66,0x3c,0x0e,0x00 ; 'q' (offset 136)
    .db 0x7c,0x66,0x66,0x7c,0x78,0x6c,0x66,0x00 ; 'r' (offset 144)
    .db 0x3c,0x66,0x60,0x3c,0x06,0x66,0x3c,0x00 ; 's' (offset 152)
    .db 0x7e,0x18,0x18,0x18,0x18,0x18,0x18,0x00 ; 't' (offset 160)
    .db 0x66,0x66,0x66,0x66,0x66,0x66,0x3c,0x00 ; 'u' (offset 168)
    .db 0x66,0x66,0x66,0x66,0x66,0x3c,0x18,0x00 ; 'v' (offset 176)
    .db 0x63,0x63,0x63,0x6b,0x7f,0x77,0x63,0x00 ; 'w' (offset 184)
    .db 0x66,0x66,0x3c,0x18,0x3c,0x66,0x66,0x00 ; 'x' (offset 192)
    .db 0x66,0x66,0x66,0x3c,0x18,0x18,0x18,0x00 ; 'y' (offset 200)
    .db 0x7e,0x06,0x0c,0x18,0x30,0x60,0x7e,0x00 ; 'z' (offset 208)
    .db 0x3c,0x30,0x30,0x30,0x30,0x30,0x3c,0x00 ; '[' (offset 216)
    .db 0x3c,0x0c,0x0c,0x0c,0x0c,0x0c,0x3c,0x00 ; ']' (offset 224)
    .db 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00 ; ' ' (offset 232)
    .db 0x18,0x18,0x18,0x18,0x00,0x00,0x18,0x00 ; '!' (offset 240)
    .db 0x66,0x66,0x66,0x00,0x00,0x00,0x00,0x00 ; '"' (offset 248)
    .db 0x66,0x66,0xff,0x66,0xff,0x66,0x66,0x00 ; '#' (offset 256)
    .db 0x18,0x3e,0x60,0x3c,0x06,0x7c,0x18,0x00 ; '$' (offset 264)
    .db 0x62,0x66,0x0c,0x18,0x30,0x66,0x46,0x00 ; '%' (offset 272)
    .db 0x3c,0x66,0x3c,0x38,0x67,0x66,0x3f,0x00 ; '&' (offset 280)
    .db 0x06,0x0c,0x18,0x00,0x00,0x00,0x00,0x00 ; ''' (offset 288)
    .db 0x0c,0x18,0x30,0x30,0x30,0x18,0x0c,0x00 ; '(' (offset 296)
    .db 0x30,0x18,0x0c,0x0c,0x0c,0x18,0x30,0x00 ; ')' (offset 304)
    .db 0x00,0x66,0x3c,0xff,0x3c,0x66,0x00,0x00 ; '*' (offset 312)
    .db 0x00,0x18,0x18,0x7e,0x18,0x18,0x00,0x00 ; '+' (offset 320)
    .db 0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x30 ; ',' (offset 328)
    .db 0x00,0x00,0x00,0x7e,0x00,0x00,0x00,0x00 ; '-' (offset 336)
    .db 0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x00 ; '.' (offset 344)
    .db 0x00,0x03,0x06,0x0c,0x18,0x30,0x60,0x00 ; '/' (offset 352)
    .db 0x3c,0x66,0x6e,0x76,0x66,0x66,0x3c,0x00 ; '0' (offset 360)
    .db 0x18,0x18,0x38,0x18,0x18,0x18,0x7e,0x00 ; '1' (offset 368)
    .db 0x3c,0x66,0x06,0x0c,0x30,0x60,0x7e,0x00 ; '2' (offset 376)
    .db 0x3c,0x66,0x06,0x1c,0x06,0x66,0x3c,0x00 ; '3' (offset 384)
    .db 0x06,0x0e,0x1e,0x66,0x7f,0x06,0x06,0x00 ; '4' (offset 392)
    .db 0x7e,0x60,0x7c,0x06,0x06,0x66,0x3c,0x00 ; '5' (offset 400)
    .db 0x3c,0x66,0x60,0x7c,0x66,0x66,0x3c,0x00 ; '6' (offset 408)
    .db 0x7e,0x66,0x0c,0x18,0x18,0x18,0x18,0x00 ; '7' (offset 416)
    .db 0x3c,0x66,0x66,0x3c,0x66,0x66,0x3c,0x00 ; '8' (offset 424)
    .db 0x3c,0x66,0x66,0x3e,0x06,0x66,0x3c,0x00 ; '9' (offset 432)
    .db 0x00,0x00,0x18,0x00,0x00,0x18,0x00,0x00 ; ':' (offset 440)
    .db 0x00,0x00,0x18,0x00,0x00,0x18,0x18,0x30 ; ';' (offset 448)
    .db 0x0e,0x18,0x30,0x60,0x30,0x18,0x0e,0x00 ; '<' (offset 456)
    .db 0x00,0x00,0x7e,0x00,0x7e,0x00,0x00,0x00 ; '=' (offset 464)
    .db 0x70,0x18,0x0c,0x06,0x0c,0x18,0x70,0x00 ; '>' (offset 472)
    .db 0x3c,0x66,0x06,0x0c,0x18,0x00,0x18,0x00 ; '?' (offset 480) 
charset_mapping:
