...
; =============
; Measure pulse-width modulated signals as generated by Samsung IR remote controls.
; This function expects the transmission to begin with a single start bit and
; this thus this very first pulse is being ignored. 
; This function will measure the length of each HIGH pulse and write
; the length of each pulse to the destination buffer.
; INPUT: r25:r24 - ptr to buffer where pulse lengths should be stored
